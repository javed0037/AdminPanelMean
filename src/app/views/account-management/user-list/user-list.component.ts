...
export class UserListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['sno', 'name', 'phone', 'email', 'action-view', 'action-block', 'action-unblock'];
  // displayedColumns: string[] = ['sno', 'name', 'phone', 'email', 'action-block', 'action-unblock'];
  dataSource;
  ...
  setDataSource(filter?: any) {
    ...
    this.http.get(url)
      .subscribe((response) => {
        this.dataSource = response['data'].users_list;
